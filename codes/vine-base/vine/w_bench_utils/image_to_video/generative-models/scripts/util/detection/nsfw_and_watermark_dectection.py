...
class DeepFloydDataFiltering(object):
    def __init__(
        ...
        self.cpu_w_weights, self.cpu_w_biases = load_model_weights(
            "./w_bench_utils/image_to_video/generative-models/scripts/util/detection/w_head_v1.npz"
        )
        self.cpu_p_weights, self.cpu_p_biases = load_model_weights(
            "./w_bench_utils/image_to_video/generative-models/scripts/util/detection/p_head_v1.npz"
        )
